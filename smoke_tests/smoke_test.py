...
# Config
# Default base switched to HTTPS with IP; override via BASE_URL env if needed.
BASE_URL = os.getenv("BASE_URL", "http://206.12.6.224:38080")
...
RTSP_URL = os.getenv("RTSP_URL", "rtsp://206.12.6.149:8554/stream3")
